...
namespace SDL {
	...
	public class Surface {
		...
		public int blit_surface(Rect? srcrect, Surface dst, Rect? dstrect);

		[CCode (cname="SDL_FillRect")]
		public int fill(Rect? dst, uint32 color);

        [CCode (cname="SDL_DisplayFormatAlpha")]
        public Surface DisplayFormatAlpha();
        [CCode (cname="SDL_DisplayFormat")]
	...
	public struct Event {
		...
		public static int peep(Event events, int numevents, 
